...
If you believe you've found a security-related bug, we prefer that you fill out a [vulnerability report on GitHub](https://github.com/kuhl-haus/kuhl-haus-bedrock-api/security/advisories/new) directly.  
...
- **Automated Security Testing**: All commits to the mainline branch undergo [automated CodeQL scanning](https://github.com/kuhl-haus/kuhl-haus-bedrock-api/actions/workflows/github-code-scanning/codeql).
- **Regular Dependency Updates**: We use Dependabot automation to keep dependencies updated. [Dependabot Updates](https://github.com/kuhl-haus/kuhl-haus-bedrock-api/actions/workflows/dependabot/dependabot-updates)
